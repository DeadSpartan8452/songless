...
function publicState(party, viewer, role) {
  ...
  // Une TV peut célébrer une bonne réponse déjà donnée. En revanche, elle ne
  // diffuse jamais l’échec individuel d’un joueur pendant que les autres jouent.
  if (role === 'tv' && anySuccess) return payload(definition, 'success', 'success');
  return null;
}

module.exports = { playerVerdict, publicState, sanitizeDefinition };
