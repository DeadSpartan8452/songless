...
| 6 — Nouveaux modes | En cours | Confiance, Coopération, Intrus, Enchères et Joker livrés côté serveur, PC, contrôleur et TV, avec tests de règles, permissions et contrôle visuel Playwright/Axe | Missions secrètes et handicap intelligent |
...
- les modes multijoueurs visibles sont Classique, Buzzer, Battle Royale, Duel,
  Confiance, Coopération, Intrus, Enchères et Joker ;
