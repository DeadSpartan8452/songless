...
| 1 — Moteur | En cours | Registre des modes et modules testés pour manches, réponses, suggestions, accès, résultats et fin Battle Royale côté serveur | Découpage progressif de `party.js` et centralisation des autres fins de partie |
