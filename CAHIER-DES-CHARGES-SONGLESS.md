...
| 3 — TV/admin | Version Android testée | `tv.html`, `remote.html`, boutons d’appairage et commandes limitées ; APK Release autonome React Native + Node embarqué ouvert sur un émulateur Android 17 neuf ; interface WebView et bibliothèque administrateur visibles ; architectures ARM64 et x86-64 ; second lancement à chaud sans serveur en double ; service d’arrière-plan et notification persistante contrôlés, serveur encore joignable après retour à l’accueil Android | Signature privée finale, compatibilité native 16 Ko, sélecteur de bibliothèque Android, antivirus et outils audio Android, écran QR centralisé, reprise après redémarrage, puis validation sur le POCO |
