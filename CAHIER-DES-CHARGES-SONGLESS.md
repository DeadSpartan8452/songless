...
| 6 — Nouveaux modes | En cours | Confiance, Coopération, Intrus et Enchères livrés côté serveur, PC, contrôleur et TV, avec tests de règles, permissions et contrôle visuel Playwright/Axe | Joker, Missions et handicap |
...
- les modes multijoueurs visibles sont Classique, Buzzer, Battle Royale, Duel,
  Confiance, Coopération, Intrus et Enchères ;
