...
| 5 — Bibliothèque | Avancée | Audit des 1 687 fichiers, favoris unifiés, sous-genres et années avec provenance/confiance, filtres précis, aperçus obligatoires avant application des années ou genres en lot, blacklist temporaire complète, validation binaire des pochettes, protection des variantes et indice de qualité explicable | Dimensions/qualité d’encodage et écran de comparaison des doublons |
