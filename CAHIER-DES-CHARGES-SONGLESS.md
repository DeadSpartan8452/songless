...
| 6 — Nouveaux modes | En cours | Confiance, Coopération et Intrus livrés côté serveur, PC, contrôleur et TV, avec tests de règles, permissions et contrôle visuel Playwright/Axe | Enchères, Joker, Missions et handicap |
...
- les modes multijoueurs visibles sont Classique, Buzzer, Battle Royale, Duel,
  Confiance, Coopération et Intrus ;
