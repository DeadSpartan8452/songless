...
| 1 — Moteur | En cours | Tests reproductibles, registre des modes, fin Battle Royale côté serveur, résultats sortis de `server.js` et accès temporaires sortis de `party.js` | Découpage progressif des gros fichiers et centralisation des autres fins de partie |
